...
class FormCheckbox extends Component<PropsFormCheckbox> {
    render() {
        return (
...
class FormRadio extends Component<PropsFormRadio> {
    render() {
        let svgIcon;
        switch (this.props.octicon) {
            case "lock":
                svgIcon = (
                    <svg
                        height="32"
                        className="octicon octicon-lock float-left mt-1 mr-2"
                        viewBox="0 0 24 24"
                        version="1.1"
                        width="32"
                        aria-hidden="true"
            ...
            case "repo":
                svgIcon = (
                    <svg
                        height="32"
                        className="octicon octicon-repo float-left mt-1 mr-2"
                        viewBox="0 0 24 24"
                        version="1.1"
                        width="32"
                        aria-hidden="true"
...
class InputLabel extends Component<PropsInputLabel> {
    render() {
        return (
        ...
        return (
            <React.Fragment>
                            ...
                            <details className="select-menu">
                                ...
                                >
                                    <img
                                        ...
                                        width="20"
                                        height="20"
                                        src="https://avatars0.githubusercontent.com/u/6856382?s=60&amp;v=4"
                                    />
                                    hyungmogu
                                </summary>
                    ...
                    <dl className="form-group required mt-1 mb-0 float-left">
                        ...
                        <dd className="form-group-body">
                            <input
                                ...
                                autoComplete="off"
                                spellCheck="false"
                                aria-describedby="input-check-4221 repo-name-suggestion"
                            />
                        </dd>
                    </dl>
                </div>
                <p className="my-2">
                    ...
                    How about <strong className="reponame-suggestion">glowing-system</strong>?
                </p>
            </React.Fragment>
        );
    }
